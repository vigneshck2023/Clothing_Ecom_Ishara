...
export default function App() {
  ...
  // Fetch all products for homepage (not search)
  useEffect(() => {
  ...
  return (
    <>
      ...
      {!isSearching ? (
            ...
            <div className="row g-4 mt-5">
              ...
              <div className="col-md-6 category-card">
                <div className="card border-0 shadow-sm h-100 d-flex flex-row align-items-center p-3">
                  <div className="flex-shrink-0">
                    <img
                      src="https://images.unsplash.com/photo-1625589562833-ab351a69f5a5?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-2">
                      Discover everyday essentials designed for comfort and
                      modern style.
                    </p>
                    <Link
              ...
              <div className="col-md-6 category-card">
                <div className="card border-0 shadow-sm h-100 d-flex flex-row align-items-center p-3">
                  <div className="flex-shrink-0">
                    <img
                      src="https://plus.unsplash.com/premium_photo-1720798654137-f6482c3ee1a2?q=80&w=1149&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-2">
                      Dress to impress with our latest party wear outfits and
                      accessories.
                    </p>
                    <Link
        ...
        // Search Results Page (uses ProductCard with strict filtering)
        <section className="container my-5">
